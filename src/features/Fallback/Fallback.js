                    ...
                    <div className="pt-32">
                        <div className="flex my-20 flex-col
                            ...
                            <h1 className="heading-1">
                                <span className="text-blue-950">Welcome to Guardian</span>
                            ...
                            <p className="text-blue-950 heading-3">Tailor your article feed to your taste via search terms or category filters above.</p>
