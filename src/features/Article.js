                ...
                <div className="grid col-span-5">
                    <div className="grid grid-cols-5">
                        ...
                        <div className="flex justify-center col-span-5 
                                        h-48 opacity-50
                                        ">
                            <img src="/resources/images/no-image.png" alt="No image available"></img>
                        </div>
                        <div className="text-justify article-text 
                                        line-clamp-4 col-span-5 mb-6
                                        ">
                        ...
                        <div className="flex col-span-5 justify-between">
                            ...
                            <button className="flex items-center justify-evenly button-blue
